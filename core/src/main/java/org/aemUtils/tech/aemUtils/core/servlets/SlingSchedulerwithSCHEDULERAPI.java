...
@Component
public class SlingSchedulerwithSCHEDULERAPI {
	...
	protected void activate(ComponentContext componentContext){
        ...
        final Runnable job3 = new Runnable() {
            public void run() {
                LOGGER.info("Executing job3 at date: {} with a delay of: {} seconds", fireDate, delay/1000);
            }
        };
        try {
	...
	protected void deactivate(ComponentContext componentContext) {
        LOGGER.info("Deactivated, goodbye!");
    }
